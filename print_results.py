...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print(f"Results using the {model} model architecture:\n")
    ...
    print(f"\nPercentage of correct matches: {results_stats_dic['pct_match']:.2f}%")
    ...
    if print_incorrect_dogs and (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']):
        ...
        for key, value in results_dic.items():
            ...
            if pet_is_dog != classifier_is_dog:
                print(f"{key}: Pet label = '{value[0]}', Classifier label = '{value[1]}'")
    ...
    if print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
        ...
        for key, value in results_dic.items():
            pet_is_dog = value[3]
            classifier_is_dog = value[4]
            if pet_is_dog == 1 and classifier_is_dog == 1 and value[2] == 0:
                print(f"{key}: Pet label = '{value[0]}', Classifier label = '{value[1]}'")
