...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        # Count number of dog and non-dog images
        if results_dic[key][3] == 1:  # Pet image is a dog
            n_dogs_img += 1
            if results_dic[key][2] == 1:  # Match between pet image and classifier label
        ...
        # Correct dog classification (pet and classifier both classify as dogs)
        if results_dic[key][3] == 1 and results_dic[key][4] == 1:
            n_correct_dogs += 1
        
        # Correct non-dog classification (pet and classifier both classify as non-dogs)
